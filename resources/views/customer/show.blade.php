    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            ...
            <div class="col-sm-12 col-lg-8">
                ...
                <a href="{{ url('customer/'.$data->id.'/delete') }}" onclick="return confirm('Are you sure you want to delete this items?')" class="btn btn-danger btn-lg"><i class="fa fa-trash"></i></a>
            </div>
        </div>
    </div>
    <!-- /.DataTales Example -->
